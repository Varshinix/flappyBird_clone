...
function preload() {
  this.load.image('background', 'assets_og/background.png');
  this.load.image('road', 'assets_og/road.png');
  this.load.image('column', 'assets_og/column.png');
  this.load.spritesheet('bird', 'assets_og/bird.png', { frameWidth: 64, frameHeight: 96 });
}
